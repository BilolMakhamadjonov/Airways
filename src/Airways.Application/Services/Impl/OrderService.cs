...
namespace Airways.Application.Services.Impl
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<CreateOrderResponceModel> CreateAsync(OrderCreateModel createTodoItemModel,
            CancellationToken cancellationToken = default)
        {
            var todoItem = _mapper.Map<Core.Entities.Order>(createTodoItemModel);
        ...
        public async Task<UpdateOrderResponceModel> UpdateAsync(Guid id, OrderUpdateModel updateTodoItemModel,
            CancellationToken cancellationToken = default)
        {
