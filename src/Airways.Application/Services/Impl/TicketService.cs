...
public class TicketService : ITicketService
{
    ...
    public async Task<CreateTicketResponceModel> CreateAsync(TicketCreateModel createTodoItemModel,
    ...
    public async Task<UpdateTicketResponceModel> UpdateAsync(Guid id, TicketUpdateModel updateTodoItemModel,
        CancellationToken cancellationToken = default)
    {
